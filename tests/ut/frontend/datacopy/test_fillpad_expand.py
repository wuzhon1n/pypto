...
"""Runtime datacopy example for plm.fillpad_expand on a dynamic valid-shape tile."""
...
@fe.kernel
def fillpad_expand_dynamic_kernel(
...
@fe.jit()
def test_fillpad_expand_dynamic():
    compiled_lib = fe.compile(fillpad_expand_dynamic_kernel, arch="a3")

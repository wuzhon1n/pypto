...
"""Runtime datacopy example for plm.fillpad on a dynamic valid-shape tile."""
...
@fe.jit()
def test_fillpad_dynamic():
    compiled_lib = fe.compile(fillpad_dynamic_kernel, arch="a3")
